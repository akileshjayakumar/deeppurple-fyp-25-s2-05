...
# def generate_chart_from_data(chart_data, chart_type):
#     """Generate a chart image from chart data and return as bytes."""
#     fig, ax = plt.subplots(figsize=(8, 6))

#     if chart_type == "bar":
#         # Assuming chart_data has x and y values
...
# def create_reportlab_image(image_bytes, width=6*inch, height=4*inch):
#     """Create a ReportLab Image object from image bytes."""
#     image_buffer = io.BytesIO(image_bytes)
#     return ReportLabImage(image_buffer, width=width, height=height)
